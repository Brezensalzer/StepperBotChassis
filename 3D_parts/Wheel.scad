...
tireCSDiameter = 5;     // Cross-sectional diameter (CS) -- How thick is the tire rubber?
tireID         = 50;    // Internal diameter (ID) -- How wide is the inside opening? 
tireStretch    = 1.02;  // Circumferential stretch percentage (usually 1 + 0-5%, e.g. 1.02) -- How 
...
maxTires          = 1;            // For o-rings/v-grooves, the maximum number of tires per wheel
...
outerHoleDiameter = 0;         // For "circlefit", the diameter of the outer holes, or zero for none
...
hubDiameter          = 16;    // The diameter of the hub portion of the wheel
...
shaftDiameter        = 5.1;          // The diameter of the motor shaft
shaftFlatDiameter    = 5.1;          // The diameter of the motor shaft at the flat, or shaftDiameter for no flat.

setScrewCount        = 1;          // The number of set screws/nuts to render, spaced evenly around the shaft 
setScrewDiameter     = 3.05;          // The diameter of the set screw. 3 is the default for an M3 screw. 
setScrewTrap         = [5.5, 2.4]; // Size [indiameter, thickness] of set screw nut. The depth is set automatically.
setScrewNutDiameter  = 5.55;        // The "diameter" of the captive nut, from flat to flat (the "in-diameter")
setScrewNutThickness = 2.45;        // The thickness of the captive nut
setScrewNutOffset    = -0.8;          // The distance to offset the nut from the center of the material. -/+ = in/out
